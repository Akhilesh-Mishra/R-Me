...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>R-Me | Admin's Report</title>
	...
	<body>
		<table align="center" width="100%" bgcolor="#FFFFFF" height="779">
			<tr>
				<td height="70">
			...
			<tr>
				<td height="500" valign="top">
					<table align="center" cellpadding="2" width="100%" border="2px">
						<tr bgcolor="#0054A8" class="whitetext" align="centre" >
							<td>Bug ID</td>
							<td>Product</td>
							<td>Env.</td>
							<td>Type</td>
							...
							while(rs.next()){
								...
								out.print("<tr><td colspan=6>");
									...
									<div class="smalltext">| 
										...
										<a href="bugdetail1.jsp?bugid=<%=rs.getString("bugid")%>">Detail</a> |
									</div>
									<%
									out.print("</td></tr>");
							}
				...
				<tr>
					<td >
						<div align="center" class="greysmall"><hr />
							All Rights are reserved with Akhilesh Kumar Mishra
						</div>
					</td>
				</tr>
			</table>
